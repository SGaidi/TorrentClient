...
from torrent-client import torent
...
EXAMPLE_TORRENT_PATH = os.listdir(os.path.join(os.path.dirname(__file__), "torrents"))[0]


def test_torrent_file(path: str = EXAMPLE_TORRENT_PATH):
...
def test_data_path(data_paths: str = EXAMPLE_FILE_PATHS):
    for data_path in data_paths:
        torrent.Torrent(data_path)
